...
function MePage() {
    ...
    async function connectSpotify() {
        try {
            setLinking(true);
            const { authorize_url } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getJson"])("/api/spotify/authorize");
            window.location.href = authorize_url;
        } catch (e) {
            setLinking(false);
            var _e_message;
            alert((_e_message = e === null || e === void 0 ? void 0 : e.message) !== null && _e_message !== void 0 ? _e_message : "Failed to start Spotify link");
        }
    }
...
_s(MePage, "VX8N/H0bYEYunNpCo5sBKctuWxg=", false, function() {
    return [
